                                        ...
                                        <div class="col-md-11 oil-bar p-4">
                                            ...
                                            <div class="d-flex flex-column align-items-end mb-3">
                                                <form action="{{ route('pdf.generate') }}" method="GET">
                                                    ...
                                                    <button type="submit" class="btn btn-danger">Cetak Laporan Bulanan (PDF)</button>
                                                </form>
                                                <a href="{{ route('pdf.generate') }}" class="btn btn-danger mt-2">Cetak Laporan Keseluruhan   (PDF)</a>
                                                <form method="GET" action="/generate-excel">
                                                    ...
                                                    <button type="submit" class="btn btn-success mt-2">Cetak Laporan Bulanan (EXCEL)</button>
                                                </form>
                                                
                                                <a href="{{ route('export.excel') }}" class="btn btn-success mt-2">Cetak Laporan Keseluruhan (Excel)</a>
                                            </div>
